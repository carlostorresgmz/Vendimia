(function(){
	...
	.config(function ($urlRouterProvider, $stateProvider, session) {
	    ...
	    var states = [
            { name: '/', dir: session.url_path + '/aplicacion/clientes', file: 'listado' },
            { name: '/agregar', dir: session.url_path + '/aplicacion/clientes', file: 'formulario' },
            { name: '/:id_cliente', dir: session.url_path + '/aplicacion/clientes', file: 'formulario' }
	    ];
