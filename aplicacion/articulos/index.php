...
<html ng-app="app" ng-controller="appCtrl" ng-init="SessionInit(<?php echo htmlspecialchars(json_encode($__enviroment)); ?>)">
	<head>
	    ...
	    <script src="<?php echo $__enviroment->url_path; ?> /aplicacion/articulos/controllers/states.js"></script>
	</head>
		...
		<div class="body-content ml-0">
			...
			<nav aria-label="breadcrumb block" role="navigation">
			    <ol class="breadcrumb mt-0 pt-2 pb-1">
			        <li class="breadcrumb-item bold" aria-current="page"><a href="#" class="mdc-text-green-700">Articulos</a></li>
			        <li class="breadcrumb-item bold" aria-current="page" id="opheader">Registrados</li>
			    </ol>		    
			</nav>
