(function(){
	...
	.config(function ($urlRouterProvider, $stateProvider, session) {
	    ...
	    var states = [
            { name: '/', dir: session.url_path + '/aplicacion/articulos', file: 'listado' },
            { name: '/agregar', dir: session.url_path + '/aplicacion/articulos', file: 'formulario' },
            { name: '/:id_articulo', dir: session.url_path + '/aplicacion/articulos', file: 'formulario' }
	    ];
